import { Directive, ElementRef, forwardRef, Host, HostListener, Provider } from '@angular/core';
...
export class DateValueAccessorDirective implements ControlValueAccessor {
  ...
  writeValue(newValue: any): void {
    if (newValue instanceof Date) {
      this.element.nativeElement.value = newValue.toISOString().split('T')[0]; // yyyy-mm-ddThh:mm:ss.000Z
    }
  }
