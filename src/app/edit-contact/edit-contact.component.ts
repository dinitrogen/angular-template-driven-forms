...
import { Contact, Phone } from '../contacts/contact.model';
...
@Component({
  imports: [CommonModule, FormsModule, RestrictedWordsValidator, DateValueAccessorDirective, ProfileIconSelectorComponent, ProfileIconSelectorComponent],
  standalone: true,
